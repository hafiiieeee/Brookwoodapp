...
class officetable extends StatefulWidget {
  const officetable({Key? key}) : super(key: key);
...
class _officetableState extends State<officetable> {
  List items = [
    Model(image: "images/table.jpg", name: "Wake up india", description:"",price: '45000'),
    Model(image: "images/table1.jpg", name: "Allie wood",description:"", price: '39000'),
